...
class Generator:
    ...
    def load_generator_weights(self, saved_weights_file_name):
        self.actual_generator.load_weights("./../model_backup/" + saved_weights_file_name)

    def save_generator_weights(self, current_time, iteration):
        self.actual_generator.save_weights("./../model_backup/" + current_time + "ep" + str(iteration) + "generator.h5")
